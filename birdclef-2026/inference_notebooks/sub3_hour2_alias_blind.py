# ============================================================================
# SUBMISSION 3 / 5 — exp019 + hour_prior (w=2.0) + sonotype_alias + site_blind
# 
# Softer hour weight, plus sonotype alias broadcast (son15=son16, son22=son23,
# howler->son14), plus extra prior weight on the 14 unlabeled sites
# (priorities 2 and 6 from user's recommendation list).
#
...
PATCHES = ['hour_prior', 'sonotype_aliases', 'site_blind']
HOUR_PRIOR_WEIGHT = 2.0
SITE_HOUR_WEIGHT = 2.5
SITE_BLIND_WEIGHT = 0.3
