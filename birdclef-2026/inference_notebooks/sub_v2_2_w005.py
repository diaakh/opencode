...
# SUB_V2_2_W005
#
# exp019 + hour_prior w=0.05 + DEAD-HOUR FIX. Simulated best weight for rank-power inputs. Expected LB delta over baseline: +0.005-0.020.
# ============================================================================
...
PATCHES = ['hour_prior']
HOUR_PRIOR_WEIGHT = 0.05
SITE_HOUR_WEIGHT = 0.05
SITE_BLIND_WEIGHT = 0.05
