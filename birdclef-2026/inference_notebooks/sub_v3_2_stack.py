# ============================================================================
# exp019 + STACKED v3 recipe (hour_prior 0.05 + site_shrinkage 0.2)
#
# Optimal stack from local benchmark: scenario A 0.9632, scenario B 0.9585. Expected LB gain over exp019 baseline: +0.005 to +0.025.
# ============================================================================
import sys
