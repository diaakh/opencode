# ============================================================================
# exp019 + sonotype alias only (no priors)
#
# Tests if alias broadcast helps at all in isolation. Today's results showed sub1==sub4 so alias=neutral on test, but at THIS weight (no hour_prior crushing) might reveal a tiny gain.
# ============================================================================
import sys
