# ============================================================================
# SUBMISSION 1 / 5 — exp019 + hour_prior (w=3.0)
# 
# Single-patch: logit-space hour-conditional boost from pseudo-cache-derived
# 24x234 prior table. Validated on Bruce OOF: 0.9304 -> 0.9586 (+0.028).
#
