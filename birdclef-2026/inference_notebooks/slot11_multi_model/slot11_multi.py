...
if exp019_csv and subv8_csv:
    ...
    # SLOT11 routing dict: class → (source_csv, weight)
    CLASS_ROUTING = {'116570': {'source': 'subv8_submission.csv', 'weight': 0.372, 'champion': 'ConvNeXt-RAG'}, '1491113': {'source': 'subv8_submission.csv', 'weight': 0.402, 'champion': 'BirdAVES-RAG'}, '22961': {'source': 'subv8_submission.csv', 'weight': 0.35, 'champion': 'BirdAVES-RAG'}, '22973': {'source': 'subv8_submission.csv', 'weight': 0.36, 'champion': 'ConvNeXt-RAG'}, '25092': {'source': 'subv8_submission.csv', 'weight': 0.368, 'champion': 'BirdAVES-RAG'}, '326272': {'source': 'subv8_submission.csv', 'weight': 0.503, 'champion': 'BirdAVES-RAG'}, '47144': {'source': 'v73_submission.csv', 'weight': 0.35, 'champion': 'V73'}, '47158son02': {'source': 'subv8_submission.csv', 'weight': 0.454, 'champion': 'ConvNeXt-RAG'}, '47158son05': {'source': 'subv8_submission.csv', 'weight': 0.595, 'champion': 'ConvNeXt-RAG'}, '47158son06': {'source': 'subv8_submission.csv', 'weight': 0.35, 'champion': 'sub_v8 MLP-5seed'}, '47158son08': {'source': 'subv8_submission.csv', 'weight': 0.387, 'champion': 'ConvNeXt-RAG'}, '47158son09': {'source': 'subv8_submission.csv', 'weight': 0.449, 'champion': 'BirdAVES-RAG'}, '47158son10': {'source': 'subv8_submission.csv', 'weight': 0.535, 'champion': 'ConvNeXt-RAG'}, '47158son12': {'source': 'subv8_submission.csv', 'weight': 0.485, 'champion': 'BirdAVES-RAG'}, '47158son13': {'source': 'subv8_submission.csv', 'weight': 0.419, 'champion': 'ConvNeXt-RAG'}, '47158son14': {'source': 'subv8_submission.csv', 'weight': 0.47, 'champion': 'ConvNeXt-RAG'}, '47158son15': {'source': 'subv8_submission.csv', 'weight': 0.35, 'champion': 'Bruce'}, '47158son16': {'source': 'subv8_submission.csv', 'weight': 0.35, 'champion': 'Bruce'}, '47158son20': {'source': 'subv8_submission.csv', 'weight': 0.364, 'champion': 'Bruce'}, '47158son24': {'source': 'subv8_submission.csv', 'weight': 0.398, 'champion': 'BirdAVES-RAG'}, '47158son25': {'source': 'subv8_submission.csv', 'weight': 0.451, 'champion': 'ConvNeXt-RAG'}, '517063': {'source': 'subv8_submission.csv', 'weight': 0.41, 'champion': 'ConvNeXt-RAG'}, '74113': {'source': 'subv8_submission.csv', 'weight': 0.399, 'champion': 'Probe Ridge'}, 'compau': {'source': 'v73_submission.csv', 'weight': 0.35, 'champion': 'V73'}, 'orwpar': {'source': 'v73_submission.csv', 'weight': 0.35, 'champion': 'V73'}, 'purjay1': {'source': 'v73_submission.csv', 'weight': 0.387, 'champion': 'V73'}, 'rufhor2': {'source': 'v73_submission.csv', 'weight': 0.35, 'champion': 'V73'}}
    
    R_final = R_exp.copy()
    n_changed = 0
    for i, c in enumerate(common):
        if c not in CLASS_ROUTING: continue
        r = CLASS_ROUTING[c]
        src = r["source"]
        w = r["weight"]  # weight for non-exp019 model
        if src == "subv8_submission.csv":
            R_final[:, i] = (1.0 - w) * R_exp[:, i] + w * R_sub[:, i]
            n_changed += 1
        elif src == "v73_submission.csv" and R_v73 is not None:
            R_final[:, i] = (1.0 - w) * R_exp[:, i] + w * R_v73[:, i]
            n_changed += 1
        # else: skip (V73 csv missing, fall back to exp019)
    print(f"  Surgical: {n_changed}/{len(common)} classes modified from pure exp019")
