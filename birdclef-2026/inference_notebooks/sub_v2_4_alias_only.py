...
# SUB_V2_4_ALIAS_ONLY
#
# exp019 + sonotype_aliases ONLY (no hour_prior). Tests if sonotype alias broadcasting is neutral/+ in isolation.
# ============================================================================
...
PATCHES = ['sonotype_aliases']
HOUR_PRIOR_WEIGHT = 0.0
SITE_HOUR_WEIGHT = 0.0
SITE_BLIND_WEIGHT = 0.0
