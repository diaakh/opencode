# AUTO-GENERATED smoke kernel. Do not edit by hand.
import os
os.environ.setdefault("NS_LIMIT_FILES", "16")
os.environ.setdefault("NS_ROUNDS", "1")
os.environ.setdefault("NS_EPOCHS", "1")
os.environ.setdefault("NS_BATCH", "32")
os.environ.setdefault("NS_WORKERS", "2")
os.environ.setdefault("NS_FOCAL_MAX_FILES", "2")
...
def pseudo_label_soundscapes(comp, ort, perch, sed, classes, limit=None, batch_files=8):
    ...
    # rank-blend the two teachers (renorm if one absent)
    ...
    elif have_p: blend = class_rank(perch_buf)
    elif have_s: blend = class_rank(sed_buf)
...
def main():
    ...
    # CRITICAL 28-class check on the raw teacher blend (before power transform sharpening)
    nonzero_teacher, zt_cov = report_zero_train_coverage("TEACHER raw blend", blend, classes, zero_train, tax)
    ...
    for rnd in range(rounds):
        ...
        pseudo_ds = AudioDataset(pseudo_frame.reset_index(drop=True), classes, args, training=True)
