...
# DIVERSITY MEMBER: eca_nfnet_l0 backbone (vs the b0/effv2s students) for a Nikita-style
# heterogeneous ensemble. Same Nikita noisy-student recipe, different architecture.
import os
os.environ.setdefault("NS_LIMIT_FILES", "4000")
os.environ.setdefault("NS_ROUNDS", "2")
os.environ.setdefault("NS_EPOCHS", "4")
os.environ.setdefault("NS_BATCH", "48")          # nfnet_l0 (~24M) heavier than b0 -> smaller batch on P100 16GB
...
os.environ.setdefault("NS_MODEL", "eca_nfnet_l0")  # the diversity backbone (genuinely different from b0/effv2s)
...
def main():
    ...
    best_path = out_dir / "ns_student_nfnet_fold1_fp16.pt"
...
def export_soundscape_preds(paths, start_secs, soft, classes, out_dir):
    ...
    outp = out_dir / "ns_student_nfnet_soundscape_preds.parquet"
