...
# === MD ===
# ### References https://www.kaggle.com/code/nina2025/birdclef-2026-eos-9?scriptVersionId=322482562
...
# | &nbsp;| &nbsp; | &nbsp; | &nbsp; | &nbsp; | &nbsp; | &nbsp; |
# | - | :-: | -: | :-: | :-: | :-: | :-: |
# |||| [ **Models** ] . [ **their LB's** ] | **type of blend** | **weights** |  x**SED** &nbsp;**schema** |
# |||||||
# || [0.949](https://www.kaggle.com/code/nina2025/birdclef-2026-eos-7-sz?scriptVersionId=322283322) |  &nbsp; v.7.prev  &nbsp; |[ 21+52+74 ] . [ 0.928+0.949+0.949 ]| [division_attention](#blend) | [[ 0.014+0.021+0.965 ](#preparing_parameters)]<br> [[ 0.0137+0.0213+0.965 ](#preparing_parameters)]  | [ [ - ] . [ - ] . [ 0.60, 0.40 ]](#preparing_parameters)
# |||||||
# || [0.949](https://www.kaggle.com/code/nina2025/birdclef-2026-eos-7-sz?scriptVersionId=322357714) |  &nbsp; v.8.prev &nbsp; |[ 21+52+74 ] . [ 0.928+0.949+0.949 ]| [div_att](#blend)+[TAX_SMOOTHING](#blend) | [[ 0.014+0.021+0.965 ](#preparing_parameters)]<br> [[ 0.0137+0.0213+0.965 ](#preparing_parameters)]  | [ [ - ] . [ - ] . [ 0.60, 0.40 ]](#preparing_parameters)
# |||||||
# || [0.950](https://www.kaggle.com/code/nina2025/birdclef-2026-eos-7-sz?scriptVersionId=322387040) |  &nbsp; v.10.prev &nbsp; |[ 22+51+74 ] . [ 0.928+0.949+0.949 ]| [direct](#blend) + [TAX_SMOOTHING](#blend) | [[ 0.022+0.0085+0.9695 ](#preparing_parameters)]  | [ [ - ] . [ - ] . [ 0.60, 0.40 ]](#preparing_parameters)
# |||||||
# || [0.950](https://www.kaggle.com/code/nina2025/birdclef-2026-eos-7-sz?scriptVersionId=322387116) |  &nbsp; v.11.prev &nbsp; |[ 22+74+51 ] . [ 0.928+0.949+0.949 ]| [direct](#blend) + [TAX_SMOOTHING](#blend) | [[ 0.022+0.0085+0.9695 ](#preparing_parameters)]  | [ [ - ] . [ - ] . [ 0.60, 0.40 ]](#preparing_parameters)
# 
# v.8 &nbsp; < &nbsp; v.7 < &nbsp; v.11 < &nbsp; v.10
...
# 
# This is the same notebook as [BirdCLEF+ 2026 | EoS.7 (bz)](https://www.kaggle.com/code/nina2025/birdclef-2026-eos-7-bz), with the only difference [mentioned](https://www.kaggle.com/code/analyticaobscura/birdclef-2026-development/comments) by the **Japanese expert**
# [**swordsman**](https://www.kaggle.com/liuyanfeng):
# 
# "**Dear, Nice job**….. I did a try as below that got a littel high score after:"
...
# 
# There are three options here: this amendment applies to both parts at once—that is, 52 and 74—or to each part separately.
# 
# Adding the post-processing function from the [EoS.8](https://www.kaggle.com/code/nina2025/birdclef-2026-eos-8?scriptVersionId=322332508) notebook - [f_TAX_SMOOTHING_POSTPROC](#blend), which apparently resulted in [LB=0.950](https://www.kaggle.com/code/mtoshidesu/test-birdclef-2026-yaroslav-v221-tax).
# 
# The following explanations were given along with this post-process feature:
# 
# - exp_071: eos5_prior065_rankpower065 &nbsp; Based on exp_069_eos5_prior065_microblend.
# - Purpose: test the next independent scalar axis after lambda_prior=0.70 regressed versus exp_069.
# - Only active code change versus exp_069: inside Model_5, change rank_aware_scaling(..., power=0.6) to power=0.65.
# - Keep lambda_prior=0.65 and the top-level EOS blend 0.0305 * Model_2 + 0.9695 * Model_5.
# 
#    
# | &nbsp;| &nbsp; | &nbsp; | &nbsp; | &nbsp; | &nbsp; | &nbsp; |
# | - | :-: | :-: | :-: | :-: | :-: | :-: |
# | [Model](#Model_1)_1<br>[Model](#Model_1)_11<br>[Model](#Model_1)_12 | [0.917](https://www.kaggle.com/code/tuckerarrants/bc2026-distilled-sed?scriptVersionId=315112860)| v.1 | [BC2026 <br> Distilled-SED](https://www.kaggle.com/code/tuckerarrants/bc2026-distilled-sed) | **m**aster | [Tucker Arrants](https://www.kaggle.com/tuckerarrants) | United States |
# |||||||
# | [Model](#Model_21)_21<br>[Model](#Model_22)_22 | [0.928](https://www.kaggle.com/code/hideyukizushi/bird26-reproduce-perch-protossm-resssm-inf-train/notebook?scriptVersionId=309368265) | v.18 | [Bird26.REPRODUCE.Perch+<br>ProtoSSM+ResSSM.INF/TRAIN](https://www.kaggle.com/code/hideyukizushi/bird26-reproduce-perch-protossm-resssm-inf-train/notebook) | grand**m**aster | [yukiZ](https://www.kaggle.com/hideyukizushi) | Japan |
# |||||||
# | [Model](#Model_51)_51<br>[Model](#Model_52)_52 | [0.949](https://www.kaggle.com/code/sunderekkiz/birdclef-2026-exp019-eos4-rank-power-06?scriptVersionId=320064228) | v.1 | [birdclef 2026 exp019 eos4 rank power 06](https://www.kaggle.com/code/sunderekkiz/birdclef-2026-exp019-eos4-rank-power-06) | contributor | [Derek](https://www.kaggle.com/sunderekkiz) | World |
# |||||||
# | [Model](#Model_73)_73<br>[Model](#Model_74)_74 | [0.949](https://www.kaggle.com/code/yaroslavkholmirzayev/v6-0949-replay?scriptVersionId=320335213) | v.6 | [v6_0949_replay](https://www.kaggle.com/code/yaroslavkholmirzayev/v6-0949-replay) | expert | [Yaroslav kholmirzayev](https://www.kaggle.com/yaroslavkholmirzayev) | Russia |
# |||||||
# 
# | &nbsp;| &nbsp; | &nbsp; | &nbsp; | &nbsp; | &nbsp; | &nbsp; |
# | - | :-: | -: | :-: | :-: | :-: | :-: |
# |||| [ **Models** ] . [ **their LB's** ] | **type of blend** | **weights** |  x**SED** &nbsp;**schema** |
# |||||||
# || [?]() |v.12|[ 22+51+74 ] . [ 0.928+0.949+0.949 ]| [direct](#blend) + [TAX_SMOOTHING](#blend) | [[ 0.020+0.013+0.967 ](#preparing_parameters)]  | [ [ - ] . [ - ] . [ 0.60, 0.40 ]](#preparing_parameters)
# || []() |v.13|[ 22+51+74 ] . [ 0.928+0.949+0.949 ]| [direct](#blend) + [TAX_SMOOTHING](#blend) | [[ 0.013+0.020+0.967 ](#preparing_parameters)]  | [ [ - ] . [ - ] . [ 0.60, 0.40 ]](#preparing_parameters)

# ---- CELL ----

# === MD ===
# #### our thoughts "out loud" relating to previous notebooks
# 
# Model_22 and Model_51 were precisely transferred from the [EoS.8](https://www.kaggle.com/code/nina2025/birdclef-2026-eos-8?scriptVersionId=322332508) notebook. After launching and receiving an evaluation, you can check the version control system to see if there were any changes!
# 
# And can you give a more or less definitive answer as to why the speed dropped?
# Is it due to the rank weighting schemes or the additional small weighting scheme (there are differences of 0.0045 – could that really be the reason!?) Or is this a bug!?? 
# 
# Any outcome would be interesting. It might come in handy at the end of the competition!
# 
# In the small diagram, there's one participant—Model_22. Here, there are two—the same Model_22 + (Model_74 or + Model_51). Moreover, Model_22 will "take" ~2/3 of the weight, leaving ~1/3 to Model_74 or Model_51, which, without the rank function, have a higher score than Model_22. Interesting, let's take a look.
# 
# And that's probably it; there's only one week left until the contest ends. And if the system rules allow it, we might still be able to try transferring some ranking settings from here to the EoS.8 notebook.
# 
# In any case, this concludes public participation in this contest.
# 
# We wish everyone strength, good spirits, and, of course, good luck!
...
solutions = {
 ...
 'task1'    : 'run SED once',
 'task2'    : {'save PSSM for Model_51 as':'subm_51p.csv'},
 'Models'   : [
  {'Model':'Model_22','subm':'subm_22.csv', 'weight':0.020,'xSED':[],         'LB':'0.928'},
  {'Model':'Model_51','subm':'subm_51p.csv','weight':0.013,'xSED':[],         'LB':'0.949'},
...
# ---- CELL ----
if 'Model_1' in _ensemble_models or \
   'task' in solutions and 'run Model_1_SED once' in solutions['task']:

    _file_name_submission = "subm_1.csv"
...
# ---- CELL ----
if 'Model_22' in _ensemble_models:

    _file_name_submission = "subm_22.csv"
...
# === MD ===
# ## Excerpts from the explanation Model_5's
# 
# ### data in his [birdclef 2026 exp019 eos4 rank power 06](https://www.kaggle.com/code/sunderekkiz/birdclef-2026-exp019-eos4-rank-power-06) by contributor [Derek](https://www.kaggle.com/sunderekkiz) :
# 
...
# ---- CELL ----
if 'Model_51' in _ensemble_models:
            
    _file_name_submission = "subm_51.csv"
    ...
    if 'Karnakbayev_PowerOptimization_LB0948' in __ensemble_models:
        
        __file_name_submission = "subm_karnakbayev_power_optimization.csv"
        ...
        sc_te_adjusted = apply_prior(sc_te, sites=meta_te["site"].to_numpy(),
                                      hours=meta_te["hour_utc"].to_numpy(), tables=prior_tables, lambda_prior=0.65)
        ...
        sc_tr_prior = apply_prior(sc_tr, sites=meta_tr["site"].to_numpy(),
                                   hours=meta_tr["hour_utc"].to_numpy(), tables=prior_tables, lambda_prior=0.65)
        ...
        probs = rank_aware_scaling(probs,    n_windows=N_WINDOWS, power=0.65)
        ...
        if 'task2' in solutions and 'save PSSM for Model_51 as' in solutions['task2']: 

            _subm_51p_csv = solutions['task2']['save PSSM for Model_51 as']
            
            sub.to_csv(_subm_51p_csv, index=False)
    ...
    def rank_1():      return direct_add_safe()
    ...
    final_submission.to_csv('subm_51.csv', index=False)
...
# ---- CELL ----
if 'Model_52' in _ensemble_models:
            
    _file_name_submission = "subm_52.csv"
    ...
    if 'Karnakbayev_PowerOptimization_LB0948' in __ensemble_models:
        ...
        if 'task2' in solutions and 'save PSSM for Model_52 as' in solutions['task2']: 

            _subm_52p_csv = solutions['task2']['save PSSM for Model_52 as']
            
            sub.to_csv(_subm_52p_csv, index=False)
        ...
        xctx = pd.DataFrame(pa_ctx).rank(axis=0, pct=True).to_numpy(np.float32)
        proto_cont = (xctx > 0.88) & (rank_proto > 0.75) & (p_sed < 0.12) & (~fake_only) # m.52
        pred = np.where(proto_cont,
                        (1.0 - 0.15) * pred + 0.15 * np.maximum(rank_proto, xctx),
                        pred)
    ...
    final_submission.to_csv('subm_52.csv', index=False)
...
# === MD ===
# ## Excerpts from the explanation Model_7's
# 
# ### data in his [v6_0949_replay](https://www.kaggle.com/code/yaroslavkholmirzayev/v6-0949-replay) by expert [Yaroslav kholmirzayev](https://www.kaggle.com/yaroslavkholmirzayev) :
# 
# expand the cell below
...
# #### exp_067: v6_prior065
# 
# Based on `exp_066_v6_prior060`.
# 
# Purpose: continue the positive prior-strength direction after `exp_066` ranked above its predecessors within displayed `0.949`.
# 
# Only change versus `exp_066`: `lambda_prior=0.60 -> 0.65` at the two active `apply_prior` call sites. Everything else stays identical.
# 
...
# 
# ### Pipeline 1: Distilled SED (Model_1)
# 
...
# 
# ### Pipeline 2: ProtoSSMv5 with Temporal Cross-Attention (Model_2)
# 
...
# 
# #### Power Optimization Pipeline & Ensemble Controller (LB 0.948)
# 
...
# ---- CELL ----
if 'Model_73' in _ensemble_models:

    _file_name_submission = "subm_73.csv"
    
    solut = {
     'type_add'  : 'direct',
     'Models'    : [
        {
         'Model' : 'Karnakbayev_PowerOptimization_LB0948_73',
         'subm'  : 'subm_karnakbayev_power_optimization_73.csv', 
         'weight': 1.0,
         'xSED'  : solutions['Models'][1]['xSED'], # from Main.level, above.level
         'LB'    : '0.948'
        }]
    }
    ...
    if 'Karnakbayev_PowerOptimization_LB0948_73' in __ensemble_models:
        ...
        prior_tables   = build_prior_tables(sc, Y_SC)
        sc_te_adjusted = apply_prior(sc_te, sites=meta_te["site"].to_numpy(),
                                      hours=meta_te["hour_utc"].to_numpy(), tables=prior_tables, lambda_prior=0.75)
        ...
        # ── xSED rank blend ───────────────────────────────────────────────────────────
        # Active current-submission path: Power optimization Proto/SED blend controlled by xSED.
        MODEL_NAME = "Karnakbayev_PowerOptimization_LB0948_73"
        _this_model = next(m for m in solut["Models"] if m["Model"] == MODEL_NAME)
        PROTO_W, SED_W = [float(v) for v in _this_model.get("xSED", [0.600, 0.400])]
        _xsed_sum = PROTO_W + SED_W
        if _xsed_sum <= 0:
        ...
        xctx = pd.DataFrame(pa_ctx).rank(axis=0, pct=True).to_numpy(np.float32)
        proto_cont = (xctx > 0.88) & (rank_proto > 0.75) & (p_sed < 0.12) & (~fake_only) # m.73
        pred = np.where(proto_cont,
                        (1.0 - 0.15) * pred + 0.15 * np.maximum(rank_proto, xctx),
                        pred)
    ...
    final_submission.to_csv('subm_73.csv', index=False)
...
# ---- CELL ----
if 'Model_74' in _ensemble_models:

    _file_name_submission = "subm_74.csv"
     ...
     'Models'    : [
        {
         ...
         'subm'  : 'subm_karnakbayev_power_optimization_74.csv', 
         'weight': 1.0,
         'xSED'  : solutions['Models'][2]['xSED'], # from Main.level, above.level
         'LB'    : '0.948'
        }]
    }
    ...
    if 'Karnakbayev_PowerOptimization_LB0948_74' in __ensemble_models:
        ...
        if 'task2' in solutions and 'save PSSM for Model_74 as' in solutions['task2']: 

            _subm_74p_csv = solutions['task2']['save PSSM for Model_74 as']
    ...
    final_submission.to_csv('subm_74.csv', index=False)
...
print (len(list_birds))

sub_w1, sub_w2 = 'half_1','half_2'
sum_w1, sum_w2 = 0,0

for i in range(len(list_birds)):
    sub_w = sub_w1 if 'son' not in list_birds[i] else sub_w2
    if sub_w=='half_1': sum_w1+=1
    if sub_w=='half_2': sum_w2+=1

print(f'half_1 = {sum_w1}.columns,   half_2 = {sum_w2}.columns')

# ---- CELL ----

# === MD ===
# You can try to find other separation boundaries—for example, into two equal parts—left and right—or three parts. And add their own weighting schemes, roughly lying in the same mass space.
# 
# This "whole thing" can be moved up a level—where weight percentages for rank functions are configured—for example, keep the original settings for 74, and use "slightly different" ones for 54. You can also see the difference like this: take this notebook and the previous EoS.6 (bz) notebook and run them one after the other from within one notebook, pressing the "Save Version" button instead of "Submit to competition." After these two runs, use the version comparison tool (press the "version N of N" button, then click the three dots in the drop-down list on the right, and select "Compare version" when the menu appears) to see the difference. 
...
def f_TAX_SMOOTHING_POSTPROC(func_add=direct, genus_α=0.15, class_α=0.05):
    ...
    # === v221 TAX SMOOTHING POSTPROC (genus α=0.15, class α=0.05) ===
    import pandas as pd, numpy as np
    print(f"[v221] Pre-tax-smoothing: shape={submission.shape}, mean={submission.values.mean():.4f}")
    ...
    for _p in tax_paths:
        if os.path.exists(_p):
            _tax = pd.read_csv(_p); break
    if _tax is None:
        print("[v221] taxonomy.csv not found — skipping tax smoothing")
    else:
        # Build species -> genus map via scientific_name first word
        _species_to_genus = {}
        _species_to_class = {}
        for _, _r in _tax.iterrows():
            _label = str(_r["primary_label"])
            _sci = str(_r.get("scientific_name", ""))
            _cls = str(_r.get("class_name", ""))
            _genus = _sci.split(" ")[0] if " " in _sci else _sci
            _species_to_genus[_label] = _genus
            _species_to_class[_label] = _cls
    
        _cols = list(submission.columns)
        _genus_groups = {}
        _class_groups = {}
        for _c in _cols:
            _g = _species_to_genus.get(_c, _c)
            _cl = _species_to_class.get(_c, "")
            _genus_groups.setdefault(_g, []).append(_c)
            if _cl: _class_groups.setdefault(_cl, []).append(_c)
    
        # Filter multi-member groups (smoothing only meaningful with siblings)
        _multi_genus = {_g: _members for _g, _members in _genus_groups.items() if len(_members) > 1}
        _multi_class = {_cl: _members for _cl, _members in _class_groups.items() if len(_members) > 1}
        print(f"[v221] multi-genus groups: {len(_multi_genus)}, multi-class groups: {len(_multi_class)}")
    
        _alpha_genus = genus_α
        _alpha_class = class_α
        
        probs = submission.values.astype(np.float32).copy()
        # Smooth by genus
        for _g, _members in _multi_genus.items():
            _idx = [_cols.index(_m) for _m in _members]
            _genus_mean = probs[:, _idx].mean(axis=1, keepdims=True)
            probs[:, _idx] = (1 - _alpha_genus) * probs[:, _idx] + _alpha_genus * _genus_mean
        # Smooth by class
        for _cl, _members in _multi_class.items():
            _idx = [_cols.index(_m) for _m in _members]
            _class_mean = probs[:, _idx].mean(axis=1, keepdims=True)
            probs[:, _idx] = (1 - _alpha_class) * probs[:, _idx] + _alpha_class * _class_mean
        submission = pd.DataFrame(probs, index=submission.index, columns=submission.columns)
        print(f"[v221] Post-tax-smoothing: mean={submission.values.mean():.4f}")
    # === END v221 ===
    # submission . to_csv(f"submission.csv", index = True) # original
    return submission
