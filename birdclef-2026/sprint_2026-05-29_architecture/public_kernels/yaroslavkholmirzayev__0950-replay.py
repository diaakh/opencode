...
solutions = {
 'type_add' : 'direct',
 'Models'   : [
  {'Model':'Model_3','subm':'subm_3.csv','weight':0.020,'xSED':[],          'LB':'SED'},
  {'Model':'Model_5','subm':'subm_5.csv','weight':0.980,'xSED':[0.60,0.40],'LB':'0.949'}
 ]
}
...
if 'Model_5' in _ensemble_models:
    ...
    _file_name_submission = "subm_5.csv"
    ...
    final_submission.to_csv('subm_5.csv', index=False)
